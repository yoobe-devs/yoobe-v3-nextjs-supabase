    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">
            Gerencie gestores, funcionários e permissões da empresa.
          </p>
        </div>
        <Button>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              Média:{' '}
              {Math.round(totalPoints / totalUsers).toLocaleString('pt-BR')}
            </p>
          </CardContent>
        </Card>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Encontre usuários específicos rapidamente
          </CardDescription>
        </CardHeader>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Lista completa de usuários da empresa
          </CardDescription>
        </CardHeader>
        <CardContent>
