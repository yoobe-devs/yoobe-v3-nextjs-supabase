...
// (Dialog removido — fluxo via galeria)
...
export default function GestorOrcamentosPage() {
  ...
  const loadData = async () => {
    try {
      ...
      // Carregar orçamentos de forma simplificada
      try {
  ...
  return (
    <div className="p-6 space-y-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <Popover>
            ...
            <PopoverContent className="w-60">
              <p className="text-sm">Criar novo orçamento pela galeria</p>
            </PopoverContent>
          </Popover>
        </div>
      </div>
                ...
                <Popover>
                  <PopoverTrigger asChild>
                    <Button
                      ...
                      size="sm"
                      onClick={() =>
                        router.push(`/gestor/orcamentos/${budget.id}`)
                      }
                    >
      ...
      {/* Modal antigo removido — fluxo consolidado via galeria */}
    </div>
  )
}
