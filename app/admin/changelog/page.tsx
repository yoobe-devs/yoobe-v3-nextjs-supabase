...
const changelogData: ChangelogEntry[] = [
  ...
  },
  {
    ...
    description: 'Implementação completa do sistema de notificações de changelog e documentação visual',
    author: 'Equipe Yoobe',
    type: 'feature',
    changes: [
  ...
  },
  {
    ...
    description: 'Lançamento da integração com Cubbo e plataformas de gamificação',
    author: 'Equipe Yoobe',
    type: 'feature',
    changes: [
  ...
  },
  {
    ...
    description: 'Otimizações de performance e melhorias na experiência do usuário',
    author: 'Equipe Yoobe',
    type: 'improvement',
    changes: [
    ...
    <div className="container mx-auto p-6 space-y-6">
      ...
      <div className="space-y-6">
        {changelogData.map((entry, index) => (
          <Card key={entry.version} className="border-l-4 border-l-blue-500 hover:shadow-lg transition-shadow">
            <CardHeader>
              <div className="flex items-start justify-between">
                ...
                >
                  {selectedVersion === entry.version ? 'Ocultar' : 'Ver detalhes'}
                  <ArrowRight className={`h-4 w-4 ml-1 transition-transform ${selectedVersion === entry.version ? 'rotate-90' : ''}`} />
                </Button>
              </div>
            </CardHeader>
            ...
            {selectedVersion === entry.version && (
              <CardContent>
                <div className="bg-gray-50 rounded-lg p-4">
                  <h4 className="font-medium text-gray-900 mb-3">Mudanças nesta versão:</h4>
