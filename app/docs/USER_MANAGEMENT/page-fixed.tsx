      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-2">
            Sistema completo de gestão de usuários, convites, roles e permissões
            da plataforma Yoobe
          </p>
        </div>
        ...
        <TabsContent value="overview" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Sistema completo de gestão de usuários com convites, roles e
                controle de acesso
              </CardDescription>
            </CardHeader>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="bg-gray-50 p-3 rounded">
                      <code className="text-sm">
                        <span className="text-yellow-600">PUT</span> /api/users/
                        {'{user_id}'}/role
                        <span className="text-gray-500 ml-2">
                          - Atualizar role
                        </span>
                  ...
                  <div className="space-y-3">
                    <div className="border-l-4 border-yellow-400 pl-4">
                      <h5 className="font-medium text-gray-900">
                        Convite não é recebido
                      </h5>
                      <p className="text-sm text-gray-600">
                        Verificar configuração de email, spam e endereço de
                        email correto.
                      </p>
                    </div>
                    <div className="border-l-4 border-red-400 pl-4">
                      ...
                      <p className="text-sm text-gray-600">
                        Verificar se o usuário está ativo, se tem role válido e
                        permissões corretas.
                      </p>
                    </div>
                  </div>
            ...
            <Link href="/docs/MULTITENANCY" className="block">
              <Card className="hover:shadow-md transition-shadow">
                <CardContent className="p-4">
                  ...
                  <p className="text-sm text-gray-600">
                    Sistema robusto de multi-tenancy
                  </p>
                </CardContent>
              </Card>
            </Link>
