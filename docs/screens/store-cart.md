...
**Nome da Tela**: Carrinho de Compras  
**Rota**: `/store/cart`  
**Objetivo Funcional**: Funcionalidade para carrinho de compras  
**Público-Alvo**: Clientes da loja, usuários autenticados  
**Regra de Negócio**: Sistema de carrinho persistente com múltiplos métodos de pagamento
...
- **badge** - Componente UI
- **input** - Componente UI
- **slider** - Componente UI
- **yoobe-logo** - Componente UI

### Hooks e Lógica

- **useState** - Hook React
- **useEffect** - Hook React
- **usePoints** - Hook React
