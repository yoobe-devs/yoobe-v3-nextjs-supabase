# 📱 Tela: Dashboard da Loja

## 🎯 Identificação e Finalidade

**Nome da Tela**: Dashboard da Loja  
**Rota**: `/store/dashboard`  
**Objetivo Funcional**: Funcionalidade para dashboard da loja  
**Público-Alvo**: Clientes da loja, usuários autenticados  
**Regra de Negócio**: Centralizar informações críticas para tomada de decisões
