...
**Nome da Tela**: Gestão de Usuários  
**Rota**: `/admin/usuarios`  
**Objetivo Funcional**: Funcionalidade para gestão de usuários  
...
- **/api/admin/users** - Endpoint da API
- **/api/users/** - Endpoint da API
