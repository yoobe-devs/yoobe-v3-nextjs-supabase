...
**Nome da Tela**: Gestão de Produtos  
**Rota**: `/gestor/produtos`  
**Objetivo Funcional**: Funcionalidade para gestão de produtos  
**Público-Alvo**: Gestores de empresa, administradores de loja  
**Regra de Negócio**: Catálogo de produtos com gestão de estoque
