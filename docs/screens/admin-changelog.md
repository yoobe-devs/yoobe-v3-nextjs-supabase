# 📱 Tela: Changelog do Sistema

## 🎯 Identificação e Finalidade

**Nome da Tela**: Changelog do Sistema  
**Rota**: `/admin/changelog`  
**Objetivo Funcional**: Funcionalidade para changelog do sistema  
...
- **/api/admin/changelog/markdown** - Endpoint da API

### Componentes Utilizados

- **markdown-renderer** - Componente UI
- **card** - Componente UI
- **badge** - Componente UI
- **button** - Componente UI
- **separator** - Componente UI
