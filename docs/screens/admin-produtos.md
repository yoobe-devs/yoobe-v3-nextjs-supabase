...
**Nome da Tela**: Catálogo de Produtos  
**Rota**: `/admin/produtos`  
**Objetivo Funcional**: Funcionalidade para catálogo de produtos  
...
- **/api/base-products** - Endpoint da API
- **/api/scraping/import-catalog** - Endpoint da API
- **/api/base-products/** - Endpoint da API
...
- **card** - Componente UI
- **badge** - Componente UI
- **safe-image** - Componente UI

### Hooks e Lógica

- **useState** - Hook React
- **useEffect** - Hook React
- **useRouter** - Hook React
- **useAuth** - Hook React
