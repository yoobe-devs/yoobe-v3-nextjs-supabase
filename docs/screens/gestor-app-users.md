...
**Nome da Tela**: Gestão de Funcionários  
**Rota**: `/gestor/usuarios`  
**Objetivo Funcional**: Funcionalidade para gestão de funcionários  
**Público-Alvo**: Gestores de empresa, administradores de loja  
**Regra de Negócio**: Gestão de usuários com controle de permissões
