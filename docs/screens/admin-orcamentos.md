# 📱 Tela: Sistema de Orçamentos

## 🎯 Identificação e Finalidade

**Nome da Tela**: Sistema de Orçamentos  
**Rota**: `/admin/orcamentos`  
**Objetivo Funcional**: Funcionalidade para sistema de orçamentos  
...
- **/api/admin/orcamentos** - Endpoint da API
- **/api/admin/orcamentos/** - Endpoint da API
...
- **input** - Componente UI
- **label** - Componente UI
- **select** - Componente UI
- **table** - Componente UI
- **dialog** - Componente UI
